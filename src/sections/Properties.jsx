...
const Properties = () => {
  ...
  return (
    <div className={`${darkMode ? "dark bg-black" : "light bg-transparent"}`}>
      <section
        ...
        } lg:w-[90%] w-full h-fit m-auto bg-cover bg-center rounded-xl flex justify-center flex-col items-center lg:px-20 px-6 py-20 mt-20 gap-20`}
      >
        ...
        >
          {property.map((item, index) => (
            <div
              ...
              data-aos-delay="200"
              key={index}
              className="bg-white dark:bg-gray-800 rounded-xl w-full border-2"
            >
              <div
                id="image-box"
              ...
              >
                <div id="top" className="flex justify-between items-end w-full">
                  <div>
                    <button className="px-3 py-1 bg-sky-600 hover:bg-white hover:text-black text-white rounded-full text-[13px]">
                      Featured
                    </button>
                  </div>
              ...
              <div className="px-6 py-3 flex flex-col justify-center items-start gap-2 w-full">
                ...
                <h1 className="text-2xl text-sky-600 font-bold dark:text-white">
                  {item.price}
                </h1>
                ...
                >
                  <div className="flex justify-center items-center gap-4">
                    <FaBath className="size-5 text-sky-400" />
                    <h1 className="dark:text-white">{item.bath}</h1>
                  </div>
                  <div className="flex justify-center items-center gap-4">
                    <FaBed className="size-5 text-sky-400" />
                    <h1 className="dark:text-white">{item.bed}</h1>
                  </div>
                  <div className="flex justify-center items-center gap-4">
                    <MdSpaceDashboard className="size-5 text-sky-400" />
  ...
  <div className="flex justify-center items-center gap-2">
    <FaUserCircle className="size-5 text-sky-400" />
    <h1 className="dark:text-white">{item.owner}</h1>
  </div>

  <div className="flex gap-2">
    <div className="p-2 border-2 border-gray-200 hover:bg-black cursor-pointer transform hover:scale-110 transition-transform duration-200">
      <FaShareAlt className="size-4 text-sky-400" />
    </div>
    <div className="p-2 border-2 border-gray-200 hover:bg-black cursor-pointer transform hover:scale-110 transition-transform duration-200">
      <FaHeart className="size-4 text-sky-400" />
    </div>
    <div className="p-2 border-2 border-gray-200 hover:bg-black cursor-pointer transform hover:scale-110 transition-transform duration-200">
      <FaPlus className="size-4 text-sky-400" />
    </div>
  </div>
</div>
