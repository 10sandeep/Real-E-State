...
const Clients = () => {
  ...
  return (
    <div className={`${darkMode ? "dark bg-black" : "light bg-transparent"}`}>
      <section
        id="testimonials"
        className="lgt:w-[95%] w-full h-fit m-auto bg-cover bg-center rounded-xl flex justify-center flex-col items-start lg:px-20 px-6 py-20 gap-20"
      >
        <div className="flex flex-col justify-center items-start gap-4">
          ...
          <h1
            data-aos="zoom-in"
            className="text-black dark:text-white text-[40px] font-bold leading-10"
          >
        ...
        >
          {client.map((item, index) => (
            <div
              ...
              data-aos-delay="200"
              key={index}
              className="bg-white dark:bg-gray-900 hover:bg-sky-100 cursor-pointer p-12 flex flex-col justify-center items-center gap-6 rounded-xl w-full border-4"
            >
